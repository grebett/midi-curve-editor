...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	var CurveWidget = function () {
	  function CurveWidget() {
	    var _this = this;

	    var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    var container = arguments[1];
	    (0, _classCallCheck3.default)(this, CurveWidget);

	    this.updateProgressLine = function (p) {
	      _this._updateProgressLine(p, 0, _this._progressLines);
	    };

	    this.initProgressLine = function () {
	      if (_this._progressLines.length === 0) {
	        _this.getMIDIValue()(0);
	        _this.store.dispatch({ type: 'ADD_PROGRESS_LINE', data: {} });
	      }
	    };
	  ...
	  (0, _createClass3.default)(CurveWidget, [{
	    ...
	    value: function _renderApp() {
	      ...
	      (0, _preact.render)((0, _preact.h)(
	        ...
	        { store: this.store },
	        (0, _preact.h)(_curveEditor2.default, {
	    ...
	    value: function _listenUnload() {
	      ...
	      window.addEventListener(unloadEvent, function () {
	        if (_this4._props.isSaveState) {
	          var preState = (0, _extends3.default)({}, _this4.store.getState());

	          delete preState.points.history;
	          delete preState.pointControls.history;
	          preState.progressLines.lines = [];

	          localStorage.setItem(_this4._localStorage, (0, _stringify2.default)(preState));
	        } else {
	          localStorage.removeItem(_this4._localStorage);
	        }
	      });
	    }
	  }, {
	    ...
	    value: function _compilePath() {
	      ...
	      this._tm = setTimeout(function () {
	        if (_this5._prevPath !== path) {
	          _this5._prevPath = path;
	          _this5._easing = mojs.easing.path(path);
	          _this5._fireOnChange(path);
	        }
	      }, 40);
	    }
	  }, {
	    ...
	    key: 'getMIDIValue',
	    value: function getMIDIValue() {
	      var _this6 = this;

	      var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	      var computeMIDIValue = function computeMIDIValue(modifier) {
	        return Math.round(modifier * 127);
	      };
	      var fun = function () {
	        var i = _this6._easings.length;
	        return function (k) {
	          var transform = _this6._easings[i].options.transform;
	          var modifier = transform ? transform(_this6._easing(k)) : _this6._easing(k);
	      ...
	      (0, _defer2.default)(function () {
	        _this6._fireOnChange(_this6._prevPath);
	      });
	      return fun;
	    }
	  }, {
	    ...
	    value: function dispose() {
	      var el = this._el.base;
	      el.parentNode.removeChild(el);
	    }
	  }, {
	    key: 'forceSaveState',
	    value: function forceSaveState() {
	      var preState = (0, _extends3.default)({}, this.store.getState());
	      delete preState.points.history;
	      delete preState.pointControls.history;
	      localStorage.setItem(this._localStorage, (0, _stringify2.default)(preState));
	    }
	  }]);
	  return CurveWidget;
	}();

	exports.default = CurveWidget;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _activePool = __webpack_require__(175);
	  ...
	  (0, _createClass3.default)(CurveEditor, [{
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        ...
	        (0, _preact.h)(_curveEditorRight2.default, {
	          state: state,
	  ...
	  return function propagating(hammer, options) {
	    ...
	    if (hammer.Manager) {
	      ...
	      var PropagatingHammer = function PropagatingHammer(element, options) {
	        var o = (0, _create2.default)(_options);
	    ...
	    var wrapper = (0, _create2.default)(hammer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CurveEditorRight = function CurveEditorRight(_ref) {
	  ...
	  return (0, _preact.h)(
	    ...
	    (0, _preact.h)(_curve2.default, { state: state, options: options, progressLines: progressLines }),
	    (0, _preact.h)(_resizeHandle2.default, {
	      state: state,
	      type: 'right',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _angleToPoint = __webpack_require__(124);
	  ...
	  (0, _createClass3.default)(Curve, [{
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        ...
	        (0, _preact.h)(
	          'div',
	          { className: CLASSES['curve__svg-wrapper'], style: styles.transform },
	    ...
	    value: function _getCurveHeight() {
	      ...
	      return _constants2.default.CURVE_SIZE * 4.28 / 6;
	    }
	  }, {
	    key: '_getStyle',
	    value: function _getStyle(state) {
	    ...
	    value: function _renderPoints(state) {
	      ...
	      for (var i = 0; i < len; i++) {
	        points.push((0, _preact.h)(_point2.default, {
	          point: pointsData[i],
	          state: state,
	          index: i,
	          pointsCount: len
	    ...
	    value: function _renderSegments(state) {
	      ...
	      for (var i = 0; i < segments.length; i++) {
	        ...
	        domSegments.push((0, _preact.h)('path', {
	          d: segment.segmentString,
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        'svg',
	        {
	          ...
	          viewBox: '0 0 ' + (350 + Math.random() * 0.0001) + ' ' + styles.height
	        },
	        (0, _preact.h)(
	          'pattern',
	          {
	            id: this._patternName,
	            x: '0',
	            y: '' + -styles.svgTop,
	            height: '350',
	            width: '350',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pointToAngle = __webpack_require__(140);
	...
	var LittleHandle = function (_Component) {
	  ...
	  (0, _createClass3.default)(LittleHandle, [{
	    ...
	    value: function render() {
	      return (0, _preact.h)(
	        'div',
	        { className: CLASSES['little-handle'], 'data-component': 'little-handle' },
	        (0, _preact.h)(
	          'div',
	          {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._little-handle_w2j61_3{position:absolute;left:50%;top:50%;width:0;height:0}._little-handle__point_w2j61_1{position:absolute;z-index:1;width:6px;height:6px;left:50%;top:50%;margin-left:-3px;margin-top:-3px;background:#4682b4;box-shadow:1px 1px 0 rgba(0,0,0,.5)}._little-handle__easy-touch_w2j61_1{position:absolute;z-index:1;width:200%;height:200%;left:50%;top:50%;margin-left:-100%;margin-top:-100%}._little-handle__line_w2j61_1{position:absolute;width:1px;height:1px;margin-left:-1px;margin-top:-1px;left:50%;top:50%;background:#add8e6;transform-origin:50% 100%}", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"little-handle":"_little-handle_w2j61_3","little-handle__point":"_little-handle__point_w2j61_1","little-handle__easy-touch":"_little-handle__easy-touch_w2j61_1","little-handle__line":"_little-handle__line_w2j61_1"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._point_1jfue_4{position:absolute;width:10px;height:10px;margin-left:-5px;margin-top:-5px;cursor:move;background:#add8e6;border-radius:50%;z-index:3;box-shadow:3px 3px 0 rgba(0,0,0,.5)}._point_1jfue_4 [data-component=little-handle]{display:none}._point__touch_1jfue_1{position:absolute;left:50%;top:50%;width:20px;height:20px;margin-left:-10px;margin-top:-10px}._point_1jfue_4._is-selected_1jfue_31,._point_1jfue_4:hover{background:#fff}._point_1jfue_4._is-selected_1jfue_31 [data-component=little-handle]{display:block}._point_1jfue_4._is-hide-handles_1jfue_41 [data-component=little-handle]{display:none}", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"point":"_point_1jfue_4","point__touch":"_point__touch_1jfue_1","is-selected":"_is-selected_1jfue_31","is-hide-handles":"_is-hide-handles_1jfue_41"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._curve_ce22j_4{position:absolute;left:0;top:10px;right:10px;bottom:10px;border-radius:2px;background:#1b1a22;border:1px solid #9c829a;box-shadow:inset 4px 4px 0 rgba(0,0,0,.5);z-index:2;overflow:hidden}._curve__background_ce22j_1{position:absolute;z-index:0;top:0;bottom:0;width:350px;left:0;opacity:.5;border-radius:inherit}._curve__background_ce22j_1 svg{width:100%}._curve__background_ce22j_1 path{vector-effect:non-scaling-stroke}._curve__svg-wrapper_ce22j_1{position:absolute;z-index:1;left:-1px;right:-1px}._curve__svg_ce22j_1{display:block;overflow:visible;width:100%;position:relative;z-index:1}._curve__svg-segment_ce22j_1{stroke:gold;stroke-width:2px;cursor:crosshair}._curve__svg-segment_ce22j_1:hover{stroke:#4682b4}", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"curve":"_curve_ce22j_4","curve__background":"_curve__background_ce22j_1","curve__svg-wrapper":"_curve__svg-wrapper_ce22j_1","curve__svg":"_curve__svg_ce22j_1","curve__svg-segment":"_curve__svg-segment_ce22j_1"}
	  ...
	  (0, _createClass3.default)(ResizeHandle, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      mc.on('pan', function (e) {
	        store.dispatch({
	          type: 'EDITOR_RESIZE',
	          data: (0, _extends3.default)({}, (0, _modDeltas2.default)(e.deltaX, e.deltaY, type, _this2.props.state))
	        });
	        e.stopPropagation();
	      }).on('panend', function (e) {
	        store.dispatch({
...
/***/ (function(module, exports) {
	...
	module.exports = {"resize-handle":"_resize-handle_x0upm_4","resize-handle--right":"_resize-handle--right_x0upm_1","resize-handle--bottom":"_resize-handle--bottom_x0upm_1"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._resize-handle_x0upm_4{background:#1b1a22;width:32px;height:16px;display:block;cursor:n-resize;overflow:hidden;position:relative;border-top-left-radius:3px;border-top-right-radius:3px;transform-origin:50% 100%;box-shadow:inset 0 0 0 1px #000}._resize-handle_x0upm_4:after{content:\"\";position:absolute;left:0;top:0;right:0;bottom:0;z-index:2}._resize-handle_x0upm_4 [data-component=icon]{position:absolute;left:0;top:-7px}._resize-handle_x0upm_4:hover{opacity:.85}._resize-handle--right_x0upm_1{transform:rotate(90deg);cursor:e-resize}._resize-handle--bottom_x0upm_1{transform:rotate(180deg);cursor:s-resize}", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"curve-editor":"_curve-editor_sg6ew_3","value-indicator":"_value-indicator_sg6ew_18","curve-editor__left":"_curve-editor__left_sg6ew_1","curve-editor__right":"_curve-editor__right_sg6ew_125","curve-editor__resize-handle":"_curve-editor__resize-handle_sg6ew_1","curve-editor__anchor-buttons":"_curve-editor__anchor-buttons_sg6ew_120","is-inactive":"_is-inactive_sg6ew_102","curve-editor__mojs-logo":"_curve-editor__mojs-logo_sg6ew_103","is-minimized":"_is-minimized_sg6ew_110","curve__svg-wrapper":"_curve__svg-wrapper_sg6ew_129","is-hidden-on-min":"_is-hidden-on-min_sg6ew_139"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pointControls = __webpack_require__(165);
	...
	var CurveEditorLeft = function CurveEditorLeft(_ref) {
	  ...
	  return (0, _preact.h)(
	    'div',
	    { className: CLASSES['curve-editor__left'], 'data-is-minimized': state.controls.isMinimize, id: 'js-left-panel' },
	    (0, _preact.h)(_pointControls2.default, {
	      state: state,
	  ...
	  (0, _createClass3.default)(PointControls, [{
	    ...
	    value: function _addButtons(controls) {
	      ...
	      for (var i = 0; i < buttonsMap.length; i++) {
	        ...
	        buttons.push((0, _preact.h)(_iconButton2.default, {
	          shape: 'point-' + type,
	          title: type,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._icon-button_1ecr8_3{position:relative;width:24px;height:24px;display:block;background:#2b2a32;border-radius:3px;box-shadow:1px 1px 0 rgba(0,0,0,.15)}._icon-button_1ecr8_3 [data-component=icon]{position:absolute;left:50%;top:50%;width:100%;height:100%;transform:translate(-50%,-50%)}._icon-button_1ecr8_3:hover{box-shadow:none}._icon-button_1ecr8_3:hover [data-component=icon]{transform:translate(-52%,-52%)}._icon-button_1ecr8_3._is-checked_1ecr8_30,._icon-button_1ecr8_3:active{border-radius:3px;box-shadow:inset -1px -1px 0 hsla(0,0%,100%,.25),inset 1px 1px 1px rgba(0,0,0,.4)}._icon-button_1ecr8_3._is-checked_1ecr8_30 [data-component=icon],._icon-button_1ecr8_3:active [data-component=icon]{transform:translate(-54%,-54%) scale(.95)}", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"icon-button":"_icon-button_1ecr8_3","is-checked":"_is-checked_1ecr8_30"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._point-controls_1b1t7_3{display:none}._point-controls_1b1t7_3 [data-component=icon-button]:after{content:\"\";position:absolute;width:3px;height:7.5px;background:#4682b4;border-top-right-radius:2px;border-bottom-right-radius:2px;left:-10px;top:50%;margin-top:-3.75px;display:none}._point-controls_1b1t7_3 [data-component=icon-button][class*=is-checked]:after,._point-controls_1b1t7_3._is-show_1b1t7_6{display:block}", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"point-controls":"_point-controls_1b1t7_3","is-show":"_is-show_1b1t7_6"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function reset(store) {
	  ...
	  store.dispatch({
	    type: 'POINT_ADD',
	    data: { point: { x: 0, y: _constants2.default.CURVE_SIZE, isLockedX: true }, index: 0 }
	  });
	  store.dispatch({
	    type: 'POINT_ADD',
	    data: { point: { x: 100, y: 0, isLockedX: true }, index: 1 }
	  });
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._curve-editor_sg6ew_3{position:relative;left:0;top:0;width:403px;height:378px;border-radius:12px;background:#050205;z-index:1;box-shadow:0 0 3px 1px rgba(0,0,0,.38)}._curve-editor_sg6ew_3 ._value-indicator_sg6ew_18{position:absolute;bottom:7px;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#fff}._curve-editor_sg6ew_3 [data-component=maximize-button]{display:none}._curve-editor_sg6ew_3 *{box-sizing:border-box}._curve-editor__left_sg6ew_1{position:absolute;width:42px;left:0;top:0;bottom:0;padding:10px;cursor:move}._curve-editor__left_sg6ew_1 [data-component=code-button]{margin-top:5px}._curve-editor__left_sg6ew_1 [data-component=icon-divider]{margin:10px auto}._curve-editor__right_sg6ew_125{position:absolute;left:43px;top:0;right:0;bottom:0}._curve-editor__right_sg6ew_125:after{content:\"\";position:absolute;left:0;top:0;right:0;bottom:0;z-index:2;display:none}._curve-editor__resize-handle_sg6ew_1{position:absolute}._curve-editor__resize-handle_sg6ew_1[data-type=top]{top:-17px}._curve-editor__resize-handle_sg6ew_1[data-type=bottom]{bottom:1px}._curve-editor__resize-handle_sg6ew_1[data-type=bottom],._curve-editor__resize-handle_sg6ew_1[data-type=top]{left:50%;margin-left:-21px}._curve-editor__resize-handle_sg6ew_1[data-type=right]{right:-15px;top:50%;margin-top:-16px}._curve-editor__anchor-buttons_sg6ew_120{margin-top:10px}._curve-editor__anchor-buttons_sg6ew_120 [data-component=icon-button]{margin-bottom:5px}._curve-editor_sg6ew_3._is-inactive_sg6ew_102 ._curve-editor__mojs-logo_sg6ew_103 [data-component=icon]{fill:#9c829a}._curve-editor_sg6ew_3._is-minimized_sg6ew_110{width:200px!important;height:160px!important;border-radius:7px}._curve-editor_sg6ew_3._is-minimized_sg6ew_110 ._curve-editor__anchor-buttons_sg6ew_120,._curve-editor_sg6ew_3._is-minimized_sg6ew_110 ._curve-editor__mojs-logo_sg6ew_103,._curve-editor_sg6ew_3._is-minimized_sg6ew_110 [data-component=code-button],._curve-editor_sg6ew_3._is-minimized_sg6ew_110 [data-component=icon-divider],._curve-editor_sg6ew_3._is-minimized_sg6ew_110 [data-component=minimize-button],._curve-editor_sg6ew_3._is-minimized_sg6ew_110 [data-component=point],._curve-editor_sg6ew_3._is-minimized_sg6ew_110 [data-component=resize-handle]{display:none}._curve-editor_sg6ew_3._is-minimized_sg6ew_110 ._curve-editor__right_sg6ew_125:after{display:block}._curve-editor_sg6ew_3._is-minimized_sg6ew_110 ._curve__svg-wrapper_sg6ew_129{margin-top:-200px}._curve-editor_sg6ew_3._is-minimized_sg6ew_110 [data-component=maximize-button]{display:block}._curve-editor_sg6ew_3._is-hidden-on-min_sg6ew_139._is-minimized_sg6ew_110{display:none}", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _resizeReducer = __webpack_require__(180);

	var _resizeReducer2 = _interopRequireDefault(_resizeReducer);

	var _pointsReducer = __webpack_require__(182);

	var _pointsReducer2 = _interopRequireDefault(_pointsReducer);

	var _controlsReducer = __webpack_require__(201);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _makePoint = __webpack_require__(193);
	...
	var _initPoints = __webpack_require__(194);

	var _initPoints2 = _interopRequireDefault(_initPoints);

	var _calculatePath = __webpack_require__(196);

	var _calculatePath2 = _interopRequireDefault(_calculatePath);

	var _deselectAll = __webpack_require__(199);

	var _deselectAll2 = _interopRequireDefault(_deselectAll);

	var _findSelectedIndecies = __webpack_require__(200);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initPoint = __webpack_require__(195);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculateSegment = __webpack_require__(197);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculatePoint = __webpack_require__(198);
