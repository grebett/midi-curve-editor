...
class Curve extends Component {
  render() {
    ...
    return (
      <div className={this._getClassName()} data-component="curve">
        <div
          id="js-background"
        ...
        <div className={CLASSES['curve__svg-wrapper']} style={styles.transform}>
          <Ruler />
          <Ruler type="right" />
  ...
  _getStyle(state) {
    ...
    let height =
      C.CURVE_SIZE - (temp_top + resize.top) + (temp_bottom + resize.bottom);
  ...
  _updateDomProgressLines() {
    ...
    const lines = this.base.querySelectorAll(
